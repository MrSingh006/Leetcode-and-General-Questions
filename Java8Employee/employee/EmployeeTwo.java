...
//    method15();
    ...
    private static void method16() {
        Map<String, Set<Employee>> m = empList.stream().collect(Collectors.groupingBy(Employee::getDepartment, Collectors.toSet()));
    ...
    private static void method9() {
        Employee e = empList.stream().min((i1,i2)->Integer.compare(i1.getYearOfJoining(),i2.getYearOfJoining())).get();
        System.out.println(e);
    }

    private static void method8() {
       Employee emp =  empList.stream().filter(i-> i.getDepartment().equalsIgnoreCase("product development")).min((i1, i2)-> Integer.compare(i1.getAge(),i2.getAge())).get();
        System.out.println(emp);
    }

    private static void method7() {
        Map<String,Double> map = empList.stream().collect(Collectors.groupingBy(Employee::getDepartment,Collectors.averagingDouble(Employee::getSalary)));
        System.out.println(map);
    }
    ...
    private static void method4() {
        Stream<Employee> s = empList.stream()
                .sorted((i1, i2)-> Double.compare(i2.getSalary(), i1.getSalary())).limit(1);
